...
import 'package:tmudirect/add_profile_picture/profile_picture.dart';
...
class _AddProfileState extends State<AddProfile> {
  ...
  sendUserdataDB() async {
    ...
    return _collectionRef
        ...
        .set(
        {
          "first-name": fisrtnamecontroller.text,
        ...
        .then((value) => Navigator.push(context, MaterialPageRoute(builder: (context)=>ProfilePicture())))
                      ...
                      child: SingleChildScrollView(
                        child: Column(
                          children: [
                            ...
                            SizedBox(height: 20,),
                            customTextField("Firstname", TextInputType.text, fisrtnamecontroller, false, null),
                            customTextField("Lastname", TextInputType.text, lastnamecontroller, false, null),
